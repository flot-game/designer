...
new InstructionConfig("arc")
    .addArg(new ArgConfig("x", "number"))
    .addArg(new ArgConfig("y", "number"))
    .addArg(new ArgConfig("radius", "number", 10))
    .addArg(new ArgConfig("startAngle", "number", 0, degreeesToRadians))
    .addArg(new ArgConfig("endAngle", "number", 360, degreeesToRadians))
...
new InstructionConfig("rect")
    .addArg(new ArgConfig("x", "number"))
    .addArg(new ArgConfig("y", "number"))
    .addArg(new ArgConfig("width", "number", 20))
    .addArg(new ArgConfig("height", "number", 20));

new InstructionConfig("ellipse")
    .addArg(new ArgConfig("x", "number"))
    .addArg(new ArgConfig("y", "number"))
    .addArg(new ArgConfig("radiusX", "number", 20))
    .addArg(new ArgConfig("radiusY", "number", 10))
...
new InstructionConfig("stroke")
    .addArg(new ArgConfig("color", "string", "#000000"))
    .addArg(new ArgConfig("lineWidth", "number", 1));

new InstructionConfig("globalAlpha")
    .addArg(new ArgConfig("alpha", "number", 1));

new InstructionConfig("translate")
    .addArg(new ArgConfig("x", "number"))
    .addArg(new ArgConfig("y", "number"));

new InstructionConfig("rotate")
    .addArg(new ArgConfig("angle", "number", 0, degreeesToRadians));

new InstructionConfig("scale")
    .addArg(new ArgConfig("x", "number", 1))
    .addArg(new ArgConfig("y", "number", 1));

new InstructionConfig("clearRect")
    .addArg(new ArgConfig("x", "number"))
    .addArg(new ArgConfig("y", "number"))
    .addArg(new ArgConfig("width", "number"))
    .addArg(new ArgConfig("height", "number"));

new InstructionConfig("clip")
    .addArg(new ArgConfig("rule", "string", "nonzero", v => ["nonzero", "evenodd"].includes(v) ? v : "nonzero"));
